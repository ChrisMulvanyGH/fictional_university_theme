<?php
    ...
    <?php
      // Returns the ID of the Parent Page e.g., 0 = Parent any higher number = Child
      $theParent = wp_get_post_parent_id(get_the_ID(get_the_ID()));

      // IF value is TRUE a number larger than 0 (false) then show breadcrumbs, else if value is FALSE (0) don't show breadcrumbs
      if ($theParent) { ?>
